...
from config import BM25_TOP_K, INDEX_PATH, DOCUMENTATION_PATH, BM25_PATH, CHUNK_SIZE, CHUNK_OVERLAP

def prepare_retrieval_resources(repository_status: RepositoryStatus, vector_store: Chroma) -> tuple[Chroma, BM25Retriever]:
    """
